...
export class Model {
  ...
  /**
   * Play mood animation based on text content
   */
  public playMoodFromText(text: string) {
    this.emoteController?.playMoodFromText(text);
  }

  /**
   * Get current mood of the character
   */
  public getCurrentMood() {
    return this.emoteController?.getCurrentMood() || 'neutral';
  }
